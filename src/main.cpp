...
unsigned int nStakeMinAge = 60 * 60 * 8; // 8 hour
...
const string strMessageMagic = "UCoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 1 * 60 * 30;  // 30mins
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "UCoinTeam 23/05 22/10/14";
        CTransaction txNew;
        txNew.nTime = 1414004789;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1414004789;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2726627;
	if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x6f882e794e9b8812be46974c72be8b5f8d2fb043d7bdb3bb4333accca31199be"));
        block.print();
